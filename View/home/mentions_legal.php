...
<p><b>Client :</b> tout professionnel ou personne physique capable au sens des articles 1123 et suivants du Code civil,
    ...
    <b>Prestations et Services :</b> <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p><b>Informations clients :</b> Ci-après dénommé « Information (s) » qui correspondent à l’ensemble des données
    personnelles susceptibles d’être détenues par <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est
    précisé aux utilisateurs du site internet <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi :
</p><p><strong>Propriétaire</strong> : Mathieu Stamm – 3 Rue Maurice Ravel 68200 Mulhouse<br>
    ...
    <strong>Hébergeur</strong> : Localhost – 3 rue maurice ravel 68200 Mulhouse 0669142804<br>
...
<p>Le Site constitue une œuvre de l’esprit protégé par les dispositions du Code de la Propriété Intellectuelle et des
...
<p>L’utilisation du site <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    ...
    d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>Ce site internet est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
    ...
    Le site web <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    est mis à jour régulièrement par <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>Le site internet <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    a pour objet de fournir une information concernant l’ensemble des activités de la société.
    <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    s’efforce de fournir sur le site <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>Toutes les informations indiquées sur le site <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>Le site utilise la technologie JavaScript.
    ...
    Le site <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p><a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p><a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    agit en tant qu’éditeur du site. <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p><a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    ...
    l’accès au site internet <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>,
...
<p><a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    ...
    d’une chance) consécutifs à l’utilisation du site <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>.
    Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
    utilisateurs. <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    ...
    données. Le cas échéant, <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>Pour les Données Personnelles collectées dans le cadre de la création du compte personnel de l’Utilisateur et de sa
    navigation sur le Site, le responsable du traitement des Données Personnelles est : Mathieu Stamm. <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>est
    représenté par Mathieu Stamm, son représentant légal</p>
...
<p>En tant que responsable du traitement des données qu’il collecte, <a
    ...
    Chaque fois que <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    traite des Données Personnelles, <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    prend toutes les mesures raisonnables pour s’assurer de l’exactitude et de la pertinence des Données Personnelles au
    regard des finalités pour lesquelles <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    les traite.</p>
...
<ul>
    ...
    <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui <a
                href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
        devra communiquer (ou non) ses données à un tiers qu’il aura préalablement désigné
    </li>
</ul>

<p>Dès que <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    a connaissance du décès d’un Utilisateur et à défaut d’instructions de sa part, <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    s’engage à détruire ses données, sauf si leur conservation s’avèrent nécessaires à des fins probatoires ou pour
    répondre à une obligation légale.</p>

<p>Si l’Utilisateur souhaite savoir comment <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    utilise ses Données Personnelles, demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut
    contacter <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    par écrit à l’adresse suivante : </p>

Mathieu Stamm – DPO, Mathieu Stamm <br>
3 Rue Maurice Ravel 68200 Mulhouse.
...
<p>
    Les demandes de suppression de Données Personnelles seront soumises aux obligations qui sont imposées à <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    par la loi, notamment en matière de conservation ou d’archivage des documents. Enfin, les Utilisateurs de <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>
    ...
    préalablement le client. Pour autant, <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    reste libre du choix de ses sous-traitants techniques et commerciaux à la condition qu’ils présentent les garanties
...
<p>
    ...
    ou la confidentialité des Informations du Client est portée à la connaissance de <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>,
    celle-ci devra dans les meilleurs délais informer le Client et lui communiquer les mesures de corrections prises.
    Par ailleurs <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>
    ...
    tiers. Seule l'hypothèse du rachat de <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    et de ses droits permettrait la transmission desdites informations à l'éventuel acquéreur qui serait à son tour tenu
...
<p>
    Pour assurer la sécurité et la confidentialité des Données Personnelles et des Données Personnelles de Santé, <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    utilise des réseaux protégés par des dispositifs standards tels que par pare-feu, la pseudonymisation, l’encryption
    et mot de passe. </p>

<p>
    Lors du traitement des Données Personnelles, <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>prend
...
<p>
    ...
    contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>.
    Cependant, <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>
    ...
    configurer son navigateur pour qu’il lui permette de décider s’il souhaite ou non les accepter de manière que des
    Cookies soient enregistrés dans le terminal ou, au contraire, qu’ils soient rejetés, soit systématiquement, soit
    selon leur émetteur. L’Utilisateur peut également configurer son logiciel de navigation de manière que l’acceptation
    ou le refus des Cookies lui soient proposés ponctuellement, avant qu’un Cookie soit susceptible d’être enregistré
    dans son terminal. <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>
    Le cas échéant, <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    décline toute responsabilité pour les conséquences liées au fonctionnement dégradé du Site et des services
    éventuellement proposés par <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>,
...
<p>
    À tout moment, l’Utilisateur peut faire le choix d’exprimer et de modifier ses souhaits en matière de Cookies. <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    pourra en outre faire appel aux services de prestataires externes pour l’aider à recueillir et à traiter les
...
<p>
    ...
    sur le Site de <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
    ou dans son application mobile et si l’Utilisateur a accepté le dépôt de cookies en poursuivant sa navigation sur le
    Site Internet ou l’application mobile de <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>,
...
<p>
    Cette technologie permet à <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
...
<p>
    Le prestataire externe pourra recueillir des informations sur les visiteurs du Site et d’autres sites Internet grâce
    à ces balises, constituer des rapports sur l’activité du Site à l’attention de <a
            href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>,
...
<p>
    Tout litige en relation avec l’utilisation du site <a href="http://localhost:8080/index.php?ctrl=home&action=index">http://localhost:8080/index.php?ctrl=home&action=index</a>
